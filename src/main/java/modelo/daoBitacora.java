...
public class daoBitacora {
    ...
    private static final String SQL_SELECT = "SELECT bitid, bitfecha, bitaccion, usuid, aplid, bitip, bitnombrepc FROM bitacora";
//private static final String SQL_SELECT = "SELECT bitid, bitfecha, bitaccion, usuid, aplid, bitip, bitnombrepc, calcularDescuento(1000, 10) FROM tbl_bitacora";    
    private static final String SQL_INSERT = "INSERT INTO bitacora(bitfecha, bitaccion, usuid, aplid, bitip, bitnombrepc) VALUES(?, ?, ?, ?, ?, ?)";
    private static final String SQL_QUERY = "SELECT bitid, bitfecha, bitaccion, usuid, aplid, bitip, bitnombrepc FROM bitacora WHERE bitfecha BETWEEN ? AND ?";    
